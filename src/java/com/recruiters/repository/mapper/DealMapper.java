...
public interface DealMapper {
    ...
    com.recruiters.model.Deal findDealByDealIdAndRecruiterId(@Param(value = "dealId") final Long dealId, @Param(value = "recruiterId") final Long recruiterId);
    ...
    com.recruiters.model.Deal findDealByIdAndEmployerId(@Param(value = "dealId") final Long dealId, @Param(value = "employerId") final Long employerId);
